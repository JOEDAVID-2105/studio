  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white p-4">
        <h1 className="font-headline text-5xl md:text-7xl font-bold tracking-tighter animate-fade-in-up">
          JOEL DAVID
        </h1>
        <p className="mt-4 text-lg md:text-xl text-muted-foreground animate-fade-in-up animate-delay-300">
