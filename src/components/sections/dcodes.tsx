      ...
      <div ref={chatContainerRef} className="mt-10 space-y-6 min-h-[200px]">
        {hasBeenVisible && !hasStartedChat && (
           <div className="flex items-start gap-3">
             ...
             <div className="rounded-lg bg-secondary p-4 max-w-xl">
                <p className="whitespace-pre-line text-xs sm:text-base text-muted-foreground leading-relaxed">{initialBotMessage}</p>
             </div>
           </div>
        )}
        ...
        {state.userInput && (
          <div className="flex items-start justify-end gap-3">
             <div className="rounded-lg bg-primary p-4 max-w-xl">
               <p className="text-primary-foreground text-xs sm:text-base">{state.userInput}</p>
             </div>
             <Avatar>
        ...
        {isPending && (
            <div className="flex items-start gap-3">
             ...
             <div className="rounded-lg bg-secondary p-4 max-w-xl">
                <p className="text-secondary-foreground flex items-center gap-2 text-xs sm:text-base"><Loader2 className="h-4 w-4 animate-spin" /> D'code is thinking...</p>
             </div>
           </div>
        )}
        ...
        {state.data && (
          <div className="flex items-start gap-3">
            ...
            <div className="rounded-lg bg-secondary p-4 max-w-xl">
              <p className="whitespace-pre-line text-xs sm:text-base text-muted-foreground leading-relaxed">
                {state.data.response}
              </p>
              <div className="mt-4">
                <ContactModal>
